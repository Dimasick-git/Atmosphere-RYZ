...
export SETTINGS    = $(ATMOSPHERE_SETTINGS) $(ATMOSPHERE_OPTIMIZATION_FLAG) -Wextra -Werror -Wno-error=unused-but-set-variable -Wno-missing-field-initializers -Wno-error=unused-result
